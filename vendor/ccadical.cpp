...
long long ccadical_solver_nodes (CCaDiCaL * ptr){
  return ((Wrapper*) ptr)->solver->get_solver_nodes();
}

long long ccadical_nb_learnt(CCaDiCaL * ptr){
  return ((Wrapper*) ptr)->solver->get_nb_learnt_clauses();
}
