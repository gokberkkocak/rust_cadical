...
long long Solver::get_solver_nodes(){
  return external->internal->stats.decisions;
}

long long Solver::get_nb_learnt_clauses(){
  return external->internal->stats.learned.clauses;
}
